...
### 🏗️ [Multi-environment Terraform with Remote State](https://github.com/siro-devops/multi-env-terraform)
...
### 🛡️ [Container Security Scanning with Trivy](https://github.com/siro-devops/container-security-scanning)
...
### ⚙️ [Microservices CI/CD Pipeline](https://github.com/siro-devops/microservices-cicd-pipeline)
...
### 🏛️ [AWS Terraform Infrastructure](https://github.com/siro-devops/aws-terraform-infrastructure)
